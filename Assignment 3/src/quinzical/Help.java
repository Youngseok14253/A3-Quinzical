...
/**
 * This class provides the implementation of the help module in the application.
 * This class and implementation will help reduce the possible confusion the
 * user might have and also reduce ambiguity when answering the questions.
 *
 * @author Do Hyun Lee, Youngseok Chae
 */
public class Help {
	/*
	 * This method implements the module in which when prompted by the user, the
	 * user is given tips and guidance on how to format the answer. The message in
	 * this method is to help the user on how they can answer the question.
	 */
